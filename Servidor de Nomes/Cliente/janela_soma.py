...
class JanelaSoma(wx.Frame):
    
    ''' Classe que constrói a janela referente a soma.'''
    ...
    def on_button(self, event):
        ...
        # Se o valor não estiver no cache, conecta no servidor para realiza a operação.
            ...
            if resultado == '0':
                ...
                f = urllib.urlopen("http://" + ip + ":3000/" + "soma?a=" + a +"&b=" + b)
                contents = f.read()
                f.close()
                ...
                soma = Number(a, b, contents)
                verifica = self.cacheSoma.insere(soma)
